...
* GitHub Issues: <https://github.com/mocniak/sorted-linked-list/issues>
...
* mocniak/sorted-linked-list follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  mocniak/sorted-linked-list automatically runs tests for pull requests. However,
...
[github]: https://github.com/mocniak/sorted-linked-list
[issues]: https://github.com/mocniak/sorted-linked-list/issues
[pull requests]: https://github.com/mocniak/sorted-linked-list/pulls
